...
//Compute shortest paths from vertex 1  
            ...
             
            vector<int> index1A;
            for(q=0; q<nA; q++) index1A.push_back(q);
              
            index1A[0]=N1;
            index1A[N1]=0;
              
...
//Compute shortest paths from vertex 2  
            ...
             
            vector<int> index2A;
            for(q=0; q<nA; q++) index2A.push_back(q);
              
            index2A[0]=N2;
            index2A[N2]=0;
              
...
//Make frequency table (sign frequency vectors) 
    ...
     
    vector<int> dummyA;
    for(i=0; i<nA; i++) dummyA.push_back(0);
     
    for(i=0; i<nA; i++) 
    {
          
...
//Compute shortest paths from vertex 1  
            ...
             
            vector<int> index1B;
            for(q=0; q<nB; q++) index1B.push_back(q);
              
            index1B[0]=N1;
            index1B[N1]=0;
              
...
//Compute shortest paths from vertex 2  
            ...
             
            vector<int> index2B;
            for(q=0; q<nB; q++) index2B.push_back(q);
              
            index2B[0]=N2;
            index2B[N2]=0;
              
...
//Make frequency table (sign frequency vectors) 
    ...
     
    vector<int> dummyB;
    for(i=0; i<nB; i++) dummyB.push_back(0);
     
    for(i=0; i<nB; i++) 
    {
          
...
//Isomorphism Index 
    ...
      
    for(i=0; i<nB; i++) fixisoB.push_back(i);
    isoB=fixisoB;
     
